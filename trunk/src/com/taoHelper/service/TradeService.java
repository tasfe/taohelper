...
public class TradeService extends BaseService {
	...
	public LogisticsInfo getCurrentLogisticsInfo(Number tid, String sellerNick) {
		...
		logisticsInfo = logisticsTOPClient.getLogisticsInfoByTid(tid,
				sellerNick);
	...
	/*
	 * ��������ͳ�� ͨ�����TradeTOPClient��getPastTrades����ͳ����ѽ��
	 */
	public Map<Integer, Double> getPaymentInMonth(String sessionKey) {
		...
		for (int i = 0; i < tradeList.size(); i++) {
			...
			if (moneyInMonth.get(month) == null) {
				...
				moneyInMonth.put(
						month,
						moneyInMonth.get(month)
								+ Double.valueOf(trade.getPayment()));
			}
	...
	/*
	 * �����Ŀ���ͳ�� ͨ�����TradeTOPClient��getPastTrades�����ʷ����
	 * ͨ��ItemTOPClient�е�getItemByIdNumId���������Ʒ����Ŀid
	 * ͨ��ItemCatTOPClient�е�getItemCatByCid�����Ʒ��Ŀ ���ﶼʹ�ø���Ŀ
	 */
